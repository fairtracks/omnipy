from typing import TypeVar, Dict, Generic, get_type_hints, get_args

from typing_inspect import get_parameters, get_generic_type, get_bound, get_args, get_last_args
