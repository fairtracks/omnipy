...
def test_split_to_and_join_items_model(
    ...
    items_stripped_tab: SplitToItemsModel = SplitToItemsModel(data_tab)
    ...
    JoinItemsByCommaModel = JoinItemsModel.adjust('JoinItemsByCommaModel', delimiter=', ')

    comma_space_joined_items = JoinItemsByCommaModel(
        items_stripped_comma[1:3])  # type: ignore[index]
