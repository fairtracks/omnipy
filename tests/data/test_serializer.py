...
import sys
from typing import Annotated, cast, Generic, NamedTuple, Type, TypeVar

import pytest
import pytest_cases as pc

from omnipy.api.protocols.public.data import CanSerialize, IsDataset, IsModel, IsSerializer
...
def text_dataset_encoded() -> Annotated[bytes, pc.fixture]:
    return b"{'data_file_\xc3\xa5': 'thirty-five \xc3\xa6', 'data_file_\xc3\x9f': 'twelve \xc3\xb8'}"
