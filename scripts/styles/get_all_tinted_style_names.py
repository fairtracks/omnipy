...
# yapf: disable
# flake8: noqa: E501
# Per Nov 1, 2025, the output of this script is:
themes_per_variant: ThemesPerVariantType = {
  (True, 'dark'): [
    ...
    ('atelier-sulphurpool.yaml', 'Atelier Sulphurpool', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ...
    ('black-metal-bathory.yaml', 'Black Metal (Bathory)', 'metalelf0 (https://github.com/metalelf0)'),
    ('black-metal-burzum.yaml', 'Black Metal (Burzum)', 'metalelf0 (https://github.com/metalelf0)'),
    ('black-metal-dark-funeral.yaml', 'Black Metal (Dark Funeral)', 'metalelf0 (https://github.com/metalelf0)'),
    ('black-metal-gorgoroth.yaml', 'Black Metal (Gorgoroth)', 'metalelf0 (https://github.com/metalelf0)'),
    ('black-metal-immortal.yaml', 'Black Metal (Immortal)', 'metalelf0 (https://github.com/metalelf0)'),
    ('black-metal-khold.yaml', 'Black Metal (Khold)', 'metalelf0 (https://github.com/metalelf0)'),
    ('black-metal-marduk.yaml', 'Black Metal (Marduk)', 'metalelf0 (https://github.com/metalelf0)'),
    ('black-metal-mayhem.yaml', 'Black Metal (Mayhem)', 'metalelf0 (https://github.com/metalelf0)'),
    ('black-metal-nile.yaml', 'Black Metal (Nile)', 'metalelf0 (https://github.com/metalelf0)'),
    ('black-metal-venom.yaml', 'Black Metal (Venom)', 'metalelf0 (https://github.com/metalelf0)'),
    ...
    ('catppuccin-macchiato.yaml', 'Catppuccin Macchiato', 'https://github.com/catppuccin/catppuccin'),
    ...
    ('charcoal-dark.yaml', 'Charcoal Dark', 'Mubin Muhammad (https://github.com/mubin6th)'),
    ('chicago-night.yaml', 'Chicago Night', 'Wendell, Ryan <ryanjwendell@gmail.com>'),
    ('chinoiserie-midnight.yaml', 'Chinoiserie Midnight', 'Di Wang (https://cs.cmu.edu/~diw3)'),
    ('chinoiserie-morandi.yaml', 'Chinoiserie Morandi', 'Di Wang (https://cs.cmu.edu/~diw3)'),
    ('chinoiserie-night.yaml', 'Chinoiserie Night', 'Di Wang (https://cs.cmu.edu/~diw3)'),
    ('circus.yaml', 'Circus', 'Stephan Boyer (https://github.com/stepchowfun) and Esther Wang (https://github.com/ewang12)'),
    ...
    ('darkviolet.yaml', 'Dark Violet', 'ruler501 (https://github.com/ruler501/base16-darkviolet)'),
    ...
    ('dracula.yaml', 'Dracula', 'Jamy Golden (http://github.com/JamyGolden), based on Dracula Theme (http://github.com/dracula)'),
    ...
    ('espresso.yaml', 'Espresso', 'Unknown. Maintained by Alex Mirrington (https://github.com/alexmirrington)'),
    ('evenok-dark.yaml', 'Evenok Dark', 'Mekeor Melire'),
    ('everforest-dark-hard.yaml', 'Everforest Dark Hard', 'Sainnhe Park (https://github.com/sainnhe)'),
    ('everforest-dark-soft.yaml', 'Everforest Dark Soft', 'Sainnhe Park (https://github.com/sainnhe)'),
    ...
    ('gruber.yaml', 'Gruber', 'Patel, Nimai <nimai.m.patel@gmail.com>, colors from www.github.com/rexim/gruber-darker-theme'),
    ('gruvbox-dark-hard.yaml', 'Gruvbox dark, hard', 'Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)'),
    ('gruvbox-dark-medium.yaml', 'Gruvbox dark, medium', 'Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)'),
    ('gruvbox-dark-pale.yaml', 'Gruvbox dark, pale', 'Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)'),
    ('gruvbox-dark-soft.yaml', 'Gruvbox dark, soft', 'Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)'),
    ('gruvbox-dark.yaml', 'Gruvbox dark', 'Tinted Theming (https://github.com/tinted-theming), morhetz (https://github.com/morhetz/gruvbox)'),
    ('gruvbox-material-dark-hard.yaml', 'Gruvbox Material Dark, Hard', 'Mayush Kumar (https://github.com/MayushKumar), sainnhe (https://github.com/sainnhe/gruvbox-material-vscode)'),
    ('gruvbox-material-dark-medium.yaml', 'Gruvbox Material Dark, Medium', 'Mayush Kumar (https://github.com/MayushKumar), sainnhe (https://github.com/sainnhe/gruvbox-material-vscode)'),
    ('gruvbox-material-dark-soft.yaml', 'Gruvbox Material Dark, Soft', 'Mayush Kumar (https://github.com/MayushKumar), sainnhe (https://github.com/sainnhe/gruvbox-material-vscode)'),
    ('hardcore.yaml', 'Hardcore', 'Chris Caller'),
    ('hardhacker.yaml', 'Hardhacker', 'fe2-Nyxar, based on the https://github.com/hardhackerlabs'),
    ...
    ('horizon-terminal-dark.yaml', 'Horizon Terminal Dark', 'Michaël Ball (http://github.com/michael-ball/)'),
    ...
    ('kanagawa-dragon.yaml', 'Kanagawa Dragon', 'Tommaso Laurenzi (https://github.com/rebelot)'),
    ...
    ('linux-vt.yaml', 'Linux VT', 'j-c-m (https://github.com/j-c-m/)'),
    ...
    ('nova.yaml', 'Nova', 'George Essig (https://github.com/gessig), Trevor D. Miller (https://trevordmiller.com)'),
    ('ocean.yaml', 'Ocean', 'Chris Kempson (http://chriskempson.com)'),
    ('oceanicnext.yaml', 'OceanicNext', 'https://github.com/voronianski/oceanic-next-color-scheme'),
    ...
    ('penumbra-dark-contrast-plus-plus.yaml', 'Penumbra Dark Contrast Plus Plus', 'Zachary Weiss (https://github.com/zacharyweiss)'),
    ('penumbra-dark-contrast-plus.yaml', 'Penumbra Dark Contrast Plus', 'Zachary Weiss (https://github.com/zacharyweiss)'),
    ...
    ('rebecca.yaml', 'Rebecca', 'Victor Borja (http://github.com/vic) based on Rebecca Theme (http://github.com/vic/rebecca-theme)'),
    ...
    ('selenized-black.yaml', 'selenized-black', 'Jan Warchol (https://github.com/jan-warchol/selenized) / adapted to base16 by ali'),
    ('selenized-dark.yaml', 'selenized-dark', 'Jan Warchol (https://github.com/jan-warchol/selenized) / adapted to base16 by ali'),
    ('seti.yaml', 'Seti UI', ''),
    ('shades-of-purple.yaml', 'Shades of Purple', 'Iolar Demartini Junior (http://github.com/demartini), based on Shades of Purple Theme (https://github.com/ahmadawais/shades-of-purple-vscode)'),
    ...
    ('snazzy.yaml', 'Snazzy', 'Chawye Hsu (https://github.com/chawyehsu), based on Hyper Snazzy Theme (https://github.com/sindresorhus/hyper-snazzy)'),
    ...
    ('spaceduck.yaml', 'Spaceduck', 'Guillermo Rodriguez (https://github.com/pineapplegiant), packaged by Gabriel Fontes (https://github.com/Misterio77)'),
    ('spacemacs.yaml', 'Spacemacs', 'Nasser Alshammari (https://github.com/nashamri/spacemacs-theme)'),
    ('sparky.yaml', 'Sparky', 'Leila Sother (https://github.com/mixcoac)'),
    ('standardized-dark.yaml', 'standardized-dark', 'ali (https://github.com/ali-githb/base16-standardized-scheme)'),
    ('stella.yaml', 'Stella', 'Shrimpram'),
    ('summerfruit-dark.yaml', 'Summerfruit Dark', 'Christopher Corley (http://christop.club/)'),
    ('synth-midnight-dark.yaml', 'Synth Midnight Terminal Dark', 'Michaël Ball (http://github.com/michael-ball/)'),
    ...
    ('terracotta-dark.yaml', 'Terracotta Dark', 'Alexander Rossell Hayes (https://github.com/rossellhayes)'),
    ...
    ('tokyodark-terminal.yaml', 'Tokyodark Terminal', 'Tiagovla (https://github.com/tiagovla/)'),
    ('tokyodark.yaml', 'Tokyodark', 'Jamy Golden (https://github.com/JamyGolden), Based on Tokyodark.nvim (https://github.com/tiagovla/tokyodark.nvim)'),
    ('tomorrow-night-eighties.yaml', 'Tomorrow Night Eighties', 'Chris Kempson (http://chriskempson.com)'),
    ...
    ('uwunicorn.yaml', 'UwUnicorn', 'Fernando Marques (https://github.com/RakkiUwU) and Gabriel Fontes (https://github.com/Misterio77)'),
    ...
    ('windows-highcontrast.yaml', 'Windows High Contrast', 'Fergus Collins (https://github.com/ferguscollins)'),
  ...
  (False, 'dark'): [
    ...
    ('everforest-dark-medium.yaml', 'Everforest Dark Medium', 'Sainnhe Park (https://github.com/sainnhe)'),
    ('icy.yaml', 'Icy Dark', 'icyphox (https://icyphox.ga)'),
    ('lime.yaml', 'lime', 'limelier'),
    ('material-vivid.yaml', 'Material Vivid', 'joshyrobot'),
    ('papercolor-dark.yaml', 'PaperColor Dark', 'Jon Leopard (http://github.com/jonleopard), based on PaperColor Theme (https://github.com/NLKNguyen/papercolor-theme)'),
  ...
  (True, 'light'): [
    ('atelier-cave-light.yaml', 'Atelier Cave Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ('atelier-dune-light.yaml', 'Atelier Dune Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ('atelier-estuary-light.yaml', 'Atelier Estuary Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ('atelier-forest-light.yaml', 'Atelier Forest Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ('atelier-heath-light.yaml', 'Atelier Heath Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ('atelier-lakeside-light.yaml', 'Atelier Lakeside Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ('atelier-plateau-light.yaml', 'Atelier Plateau Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ('atelier-savanna-light.yaml', 'Atelier Savanna Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ('atelier-seaside-light.yaml', 'Atelier Seaside Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ('atelier-sulphurpool-light.yaml', 'Atelier Sulphurpool Light', 'Bram de Haan (http://atelierbramdehaan.nl)'),
    ...
    ('charcoal-light.yaml', 'Charcoal Light', 'Mubin Muhammad (https://github.com/mubin6th)'),
    ('chicago-day.yaml', 'Chicago Day', 'Wendell, Ryan <ryanjwendell@gmail.com>'),
    ('chinoiserie.yaml', 'Chinoiserie', 'Di Wang (https://cs.cmu.edu/~diw3)'),
    ...
    ('grayscale-light.yaml', 'Grayscale Light', 'Alexandre Gavioli (https://github.com/Alexx2/)'),
    ('gruvbox-light-hard.yaml', 'Gruvbox light, hard', 'Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)'),
    ('gruvbox-light-medium.yaml', 'Gruvbox light, medium', 'Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)'),
    ('gruvbox-light-soft.yaml', 'Gruvbox light, soft', 'Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)'),
    ('gruvbox-light.yaml', 'Gruvbox Light', 'Tinted Theming (https://github.com/tinted-theming), morhetz (https://github.com/morhetz/gruvbox)'),
    ('gruvbox-material-light-hard.yaml', 'Gruvbox Material Light, Hard', 'Mayush Kumar (https://github.com/MayushKumar), sainnhe (https://github.com/sainnhe/gruvbox-material-vscode)'),
    ('gruvbox-material-light-medium.yaml', 'Gruvbox Material Light, Medium', 'Mayush Kumar (https://github.com/MayushKumar), sainnhe (https://github.com/sainnhe/gruvbox-material-vscode)'),
    ('gruvbox-material-light-soft.yaml', 'Gruvbox Material Light, Soft', 'Mayush Kumar (https://github.com/MayushKumar), sainnhe (https://github.com/sainnhe/gruvbox-material-vscode)'),
    ('harmonic16-light.yaml', 'Harmonic16 Light', 'Jannik Siebert (https://github.com/janniks)'),
    ...
    ('horizon-terminal-light.yaml', 'Horizon Terminal Light', 'Michaël Ball (http://github.com/michael-ball/)'),
    ...
    ('nord-light.yaml', 'Nord Light', "threddast, based on fuxialexander's doom-nord-light-theme (Doom Emacs)"),
    ('one-light.yaml', 'One Light', 'Daniel Pfeifer (http://github.com/purpleKarrot)'),
    ('oxocarbon-light.yaml', 'Oxocarbon Light', 'shaunsingh/IBM'),
    ('papercolor-light.yaml', 'PaperColor Light', 'Jon Leopard (http://github.com/jonleopard), based on PaperColor Theme (https://github.com/NLKNguyen/papercolor-theme)'),
    ('penumbra-light-contrast-plus-plus.yaml', 'Penumbra Light Contrast Plus Plus', 'Zachary Weiss (https://github.com/zacharyweiss)'),
    ('penumbra-light-contrast-plus.yaml', 'Penumbra Light Contrast Plus', 'Zachary Weiss (https://github.com/zacharyweiss)'),
    ('penumbra-light.yaml', 'Penumbra Light', 'Zachary Weiss (https://github.com/zacharyweiss)'),
    ...
    ('selenized-light.yaml', 'selenized-light', 'Jan Warchol (https://github.com/jan-warchol/selenized) / adapted to base16 by ali'),
    ('selenized-white.yaml', 'selenized-white', 'Jan Warchol (https://github.com/jan-warchol/selenized) / adapted to base16 by ali'),
    ...
    ('solarflare-light.yaml', 'Solar Flare Light', 'Chuck Harmston (https://chuck.harmston.ch)'),
    ('solarized-light.yaml', 'Solarized Light', 'Ethan Schoonover (modified by aramisgithub)'),
    ('standardized-light.yaml', 'standardized-light', 'ali (https://github.com/ali-githb/base16-standardized-scheme)'),
    ('still-alive.yaml', 'Still Alive', 'Derrick McKee (derrick.mckee@gmail.com)'),
    ('summerfruit-light.yaml', 'Summerfruit Light', 'Christopher Corley (http://christop.club/)'),
    ('synth-midnight-light.yaml', 'Synth Midnight Terminal Light', 'Michaël Ball (http://github.com/michael-ball/)'),
    ('terracotta.yaml', 'Terracotta', 'Alexander Rossell Hayes (https://github.com/rossellhayes)'),
    ...
    ('windows-95-light.yaml', 'Windows 95 Light', 'Fergus Collins (https://github.com/ferguscollins)'),
    ('windows-highcontrast-light.yaml', 'Windows High Contrast Light', 'Fergus Collins (https://github.com/ferguscollins)')
  ],
  (False, 'light'): [
    ...
    ('windows-10-light.yaml', 'Windows 10 Light', 'Fergus Collins (https://github.com/ferguscollins)'),
    ('windows-nt-light.yaml', 'Windows NT Light', 'Fergus Collins (https://github.com/ferguscollins)')
  ]
}
